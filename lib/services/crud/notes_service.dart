...
//       _notesStreanController.stream.filter((note) {
...
//         noteTable, {textColumn: text, isSyncedWithServerColumn: 0},
...
//         id: noteId, text: text, userId: owner.id, isSyncedWithServer: true);
//     // Add note to cache.
//     _notes.add(note);
//     _notesStreanController.add(_notes);
//     return note;
